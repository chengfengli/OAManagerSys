...
_e(function (E, $) {
    ...
    E.config.emotions = {
		...
		"self":{
			...
			data: [
				{
					"icon": "http://img3.imgtn.bdimg.com/it/u=2932755451,3969826854&fm=23&gp=0.jpg",
					"value": "[ali哇]"
				},
				{
					"icon":"http://img5.imgtn.bdimg.com/it/u=1355129401,2974606064&fm=23&gp=0.jpg",
					"value":"猫"
				},
				{
					"icon":"http://img2.imgtn.bdimg.com/it/u=226245737,4286322721&fm=23&gp=0.jpg",
					"value":"性感"
				}
			]
		}
...
_e(function (E, $) {
     ...
     // 为菜单自定义配置的UI
     E.UI.menus = {
        // 这个 default 不加引号，在 IE8 会报错class="wangeditor-menu-img-bold"
        'default': {
